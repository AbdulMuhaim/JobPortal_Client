...
const callouts = [
    {
        name: 'Civil Engineer',
        description: 'Plan, design, and supervise the construction',
      ...
      },
    {
      ...
      description: 'Possess strong problem-solving skills',
    ...
    },
    {
      ...
      description: 'Making rounds and performing patient exams',
    ...
    {
        name: 'UI Designer',
        description: 'Create an intuitive and visually appealing interface for product design',
      ...
      {
        name: 'Photographer',
        description: 'Submitting photos to appropriate persons',
      ...
      },
      {
        ...
        description: 'Demonstrating and presenting products',
