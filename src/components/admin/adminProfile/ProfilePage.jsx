...
<div className="p-5 bg-white shadow mt-24">
  <div className="grid grid-cols-1 md:grid-cols-3">
    ...
    <img src="https://cdn.i-scmp.com/sites/default/files/d8/images/canvas/2022/04/11/5c08df4e-fdbb-4fed-bbdf-2b408cde0f93_8e21b67c.jpg"  className="w-48 h-48 bg-indigo-100 mx-auto rounded-full shadow-2xl absolute inset-x-0 top-0 -mt-24 flex items-center justify-center text-indigo-500" alt="" />
    </div>
