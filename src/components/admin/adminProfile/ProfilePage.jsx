...
<div className="p-5 bg-white shadow mt-24">
  <div className="grid grid-cols-1 md:grid-cols-3">
    ...
    <img src="https://hips.hearstapps.com/hmg-prod/images/gettyimages-1071221632.jpg"  className="w-48 h-48 bg-indigo-100 mx-auto rounded-full shadow-2xl absolute inset-x-0 top-0 -mt-24 flex items-center justify-center text-indigo-500" alt="" />
    </div>
