...
import { fetchCardDatas } from "../../../api/AdminApi";
...
function Cards() {
  ...
  return (
    <>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4 w-full">
      {/* Card 1 */}
      <div className="bg-blue-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
        ...
        <div className="text-right">
          <p className="text-2xl">{cardData.employeesCount}</p>
          <p>Employees</p>
        </div>
      </div>
      ...
      <div className="bg-blue-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
        ...
        <div className="text-right">
          <p className="text-2xl">{cardData.employersCount}</p>
          <p>Employers</p>
        </div>
      </div>
      ...
      <div className="bg-blue-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
        ...
        <div className="text-right">
          <p className="text-2xl">{cardData.jobsCount}</p>
          <p>Jobs</p>
        </div>
      </div>
      ...
      <div className="bg-blue-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
        ...
        <div className="text-right">
          <p className="text-2xl">{cardData.categoriesCount}</p>
          <p>Job Categories</p>
        </div>
      </div>
    </div>
